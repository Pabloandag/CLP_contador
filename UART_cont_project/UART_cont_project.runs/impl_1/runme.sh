...
HD_PWD='C:/Users/aguir/Documents/CESE/CLP/contador/UART_cont_project/UART_cont_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_cont.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_cont.tcl -notrace
