...
HD_PWD='C:/Users/aguir/Documents/CESE/CLP/contador/UART_cont_project/UART_cont_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_cont.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_cont.tcl
