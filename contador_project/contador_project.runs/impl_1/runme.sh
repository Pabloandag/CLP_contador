...
HD_PWD='C:/Users/aguir/Documents/CESE/CLP/contador/contador_project/contador_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log contNb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source contNb.tcl -notrace
