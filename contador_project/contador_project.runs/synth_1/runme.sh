...
HD_PWD='C:/Users/aguir/Documents/CESE/CLP/contador/contador_project/contador_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log contNb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source contNb.tcl
